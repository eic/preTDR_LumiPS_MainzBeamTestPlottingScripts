...
### To generate the plot appearing in the preTDR:

`sixteenSiPMCoincidence.C` on all outputs from runs: `25-08-01_Tagger26`, `25-08-02_Tagger18`, `25-08-02_Tagger12`, `25-08-07_Tagger10`.
`totalEnergyMultipleRuns.C` is then run on each of those outputs.
`multiRunTaggerPositionEnergy.C` creates the plot comparing the runs.
